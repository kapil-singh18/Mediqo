...
import { Stethoscope, LogOut, ChevronDown, Calendar, User, Clock, Home } from 'lucide-react';
...
export const PatientLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { label: 'Book Doctor', path: '/doctors', icon: Calendar },
          ...
          <div className="flex items-center justify-between h-18">
            ...
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold tracking-tight text-gray-900">
                Mediqo <span className="text-xs font-normal text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full ml-1">Patient Portal</span>
              </span>
            </Link>
