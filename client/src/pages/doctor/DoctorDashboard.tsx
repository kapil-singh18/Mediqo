      ...
      <div className="bg-[#5F6FFF] rounded-[16px] p-6 sm:p-8 text-white shadow-md shadow-[#5F6FFF]/10 relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <div className="relative z-10 flex flex-wrap gap-2.5">
          ...
          <Link to="/doctor/appointments">
            <Button variant="secondary" className="bg-white text-[#5F6FFF] hover:bg-blue-50 font-bold px-5 py-2 rounded-full text-xs uppercase tracking-wider border border-white/80 shadow-xs">
              <Calendar className="w-3.5 h-3.5 mr-1 text-[#5F6FFF]" /> Schedule
            </Button>
          </Link>
