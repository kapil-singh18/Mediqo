      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {doctorsData.slice(0, 8).map((doc) => (
            ...
            >
              <div>
                <div className="h-48 bg-[#EAEEFF] relative overflow-hidden flex items-center justify-center">
                  <DoctorAvatar
                    src={doc.image}
                    name={doc.name}
                  ...
                  />
                  <div className="absolute top-3 left-3 bg-white/90 backdrop-blur-xs px-2.5 py-1 rounded-full flex items-center gap-1.5 shadow-xs z-10">
